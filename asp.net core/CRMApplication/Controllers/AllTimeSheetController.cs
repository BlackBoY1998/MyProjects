...
namespace CRMApplication.Controllers
{
    ...
    public class AllTimeSheetController : Controller
    {
        ...
        private AllTimeSheetConsume ObjAllTimesheet;
        public AllTimeSheetController()
        {
            ObjAllTimesheet = new AllTimeSheetConsume();
        ...
        public ActionResult Details(string id)
        {
            try
            {
                ...
                objMT.ListTimeSheetDetails = ObjAllTimesheet.TimesheetDetailsbyTimeSheetMasterID("TimesheetDetailsbyTimeSheetMasterID", Convert.ToInt32(Session["UserID"]), Convert.ToInt32(id));
                objMT.ListofProjectNames = ObjAllTimesheet.GetProjectNamesbyTimeSheetMasterID("GetProjectNamesbyTimeSheetMasterID", Convert.ToInt32(id));
                objMT.ListofPeriods = ObjAllTimesheet.GetPeriodsbyTimeSheetMasterID("GetPeriodsbyTimeSheetMasterID", Convert.ToInt32(id));
