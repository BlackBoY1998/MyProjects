...
namespace CRMApplication.Controllers
{
    ...
    {
        private TimeSheetMasterExportConsume objTimeSheetConsume;
        ITimeSheetExport _ITimeSheetExport;
        ITimeSheet _ITimeSheet;
        public TimeSheetMasterExportController()
        {
            objTimeSheetConsume = new TimeSheetMasterExportConsume();
                    ...
                    if (timesheetdata.Tables.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            for (int k = 0; k < timesheetdata.Tables[0].Rows.Count; k++)
                            {
                                ...
                                var ListofProjectNames = objTimeSheetConsume.GetProjectNamesbyTimeSheetMasterID("GetProjectNamesbyTimeSheetMasterID", Convert.ToInt32(timesheetID));
