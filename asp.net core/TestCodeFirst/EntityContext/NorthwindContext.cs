...
using TestCodeFirst.Entities;
using TestCodeFirst.Models;
#nullable disable

namespace TestCodeFirst.EntityContext
{
...
//                optionsBuilder.UseNpgsql("Host=localhost;Port=5432;User ID=postgres;Password=ntspl@123;Database=Northwind;Pooling=true;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasIndex(e => e.HomePhone, "idx_home_phone");
