                        ...
                        else
                        {
                            ...
                            for (int k = 0; k < timesheetdata.Tables[0].Rows.Count; k++)
                            {
                                ...
                                for (int i = 0; i < ListofProjectNames.Count(); i++)
                                {
                                    ...
                                    var ListofDescription = TimesheetManagement.Helpers.MethodonViews.GetDescriptionbyTimeSheetMasterID(timesheetID, ListofProjectNames[i].ProjectID);
